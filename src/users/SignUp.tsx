                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">이메일(E-mail)</label>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label htmlFor="terms" className="font-medium text-blue-600 dark:text-blue-500">계정 가입에 동의합니다</label>
                                </div>
                            </div>
                            <button type="submit" className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">회원가입 완료</button>
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                이미 가입하셨다고요? <a href="/LogIn" className="font-medium text-blue-600 hover:underline dark:text-blue-500">로그인 하러가기</a>
                            </p>
                        </form>
                    </div>
                </div>
