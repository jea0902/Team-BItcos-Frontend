...
const LongBtn : React.FC<LongBtnProps> = ({
  ...
  return (
    <div className='LongBtn-Container'>
        <button type="button" className="btn btn-primary custom-Long-Btn" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">롱 {`${longLeverage}배`}</button>
